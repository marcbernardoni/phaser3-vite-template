...
```bash
npx degit https://github.com/marcbernardoni/phaser3-vite-template my-folder-name
cd my-folder-name
...
[MIT License](https://github.com/marcbernardoni/phaser3-vite-template/blob/master/LICENSE)
